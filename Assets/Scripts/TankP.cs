...
{
    [Serializable]
    public class TankP : NetworkBehaviour
    {
        ...
        public Constants.Direction lastDir = Constants.Direction.NO;
        
        [HideInInspector] public static TankP localPlayer;
        ...
        public Constants.Direction GetNextMove(GameStateP game, Constants.CellType[,] logicMap, Vector2 otherPosition)
        {
